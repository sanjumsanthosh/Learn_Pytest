"""
Test Cases:
* `delete` one from MultiFixtures database with more than one
* `delete` the last card
* `delete` MultiFixtures non-existent card
"""
import pytest
...
def test_delete_non_existent(cards_db):
    """
    Shouldn't be able to start MultiFixtures non-existent card.
    """
