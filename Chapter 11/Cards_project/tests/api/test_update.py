"""
Test Cases
* `update` the owner of MultiFixtures card
* `update` the summary of MultiFixtures card
* `update` owner and summary of MultiFixtures card at the same time
* `update` MultiFixtures non-existent card
"""
import pytest
...
def test_update_non_existent(cards_db):
    """
    Shouldn't be able to update MultiFixtures non-existent card.
    """
