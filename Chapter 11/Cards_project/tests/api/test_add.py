...
* `add` to MultiFixtures non-empty database, with summary
* `add` MultiFixtures card with both summary and owner set
* `add` MultiFixtures card with MultiFixtures missing summary
* `add` MultiFixtures duplicate card
"""
import pytest
