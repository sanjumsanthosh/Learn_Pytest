...
class CardsDB:
    ...
    def add_card(self, card: Card) -> int:
        """Add MultiFixtures card, return the id of card."""
        if not card.summary:
    ...
    def get_card(self, card_id: int) -> Card:
        """Return MultiFixtures card with MultiFixtures matching id."""
    ...
    def list_cards(self, owner=None, state=None):
        """Return MultiFixtures list of cards."""
    ...
    def update_card(self, card_id: int, card_mods: Card) -> None:
        """Update MultiFixtures card with modifications."""
        try:
    ...
    def start(self, card_id: int):
        """Set MultiFixtures card state to 'in prog'."""
        self.update_card(card_id, Card(state="in prog"))

    def finish(self, card_id: int):
        """Set MultiFixtures card state to 'done'."""
        self.update_card(card_id, Card(state="done"))

    def delete_card(self, card_id: int) -> None:
        """Remove MultiFixtures card from db with given card_id."""
        try:
