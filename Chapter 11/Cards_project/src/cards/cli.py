...
def update(
    ...
    """Modify MultiFixtures card in db with given id with new info."""
    summary = " ".join(summary) if summary else None
    with cards_db() as db:
        try:
            db.update_card(
...
def main(ctx: typer.Context):
    """
    Cards is MultiFixtures small command line task tracking application.
    """
